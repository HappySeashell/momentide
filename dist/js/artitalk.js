(function () {
  ...
  (function (global) {
      ...
      function request(path, options) {
          ...
          if (options.authenticated) {
              const token = (_a = storedUser()) === null || _a === void 0 ? void 0 : _a.sessionToken;
              if (token)
              ...
              logIn: function (username, password) {
                  return request('/login', {
                      ...
                      const user = {
                          ...
                          attributes: Object.assign({}, raw.attributes || {}, { username: raw.username || ((_a = raw.attributes) === null || _a === void 0 ? void 0 : _a.username) }),
                          sessionToken: raw.sessionToken
                      };
                      if (global.localStorage)
                          global.localStorage.setItem(storageKey, JSON.stringify(user));
                      return user;
                  });
              },
              logOut: function () {
                  return request('/logout', { method: 'POST', authenticated: true }).then(function () {
                      if (global.localStorage)
                          global.localStorage.removeItem(storageKey);
                  });
              }
  ...
  !(function (n) {
      ...
      function i(n, t) { var r, e, o, u; n[t >> 5] |= 128 << t % 32, n[14 + (t + 64 >>> 9 << 4)] = t; for (var c = 1732584193, f = -271733879, i = -1732584194, a = 271733878, h = 0; h < n.length; h += 16)
      ...
      function a(n) { for (var t = '', r = 32 * n.length, e = 0; e < r; e += 8)
          t += String.fromCharCode(n[e >> 5] >>> e % 32 & 255); return t; }
      function h(n) { var t = []; for (t[(n.length >> 2) - 1] = void 0, e = 0; e < t.length; e += 1)
          t[e] = 0; for (var r = 8 * n.length, e = 0; e < r; e += 8)
          t[e >> 5] |= (255 & n.charCodeAt(e / 8)) << e % 32; return t; }
      function e(n) { for (var t, r = '0123456789abcdef', e = '', o = 0; o < n.length; o += 1)
          t = n.charCodeAt(o), e += r.charAt(t >>> 4 & 15) + r.charAt(15 & t); return e; }
      function r(n) { return unescape(encodeURIComponent(n)); }
      function o(n) { return a(i(h(t = r(n)), 8 * t.length)); var t; }
      function u(n, t) { return (function (n, t) { var r; var e; var o = h(n); var u = []; var c = []; for (u[15] = c[15] = void 0, o.length > 16 && (o = i(o, 8 * n.length)), r = 0; r < 16; r += 1)
          u[r] = 909522486 ^ o[r], c[r] = 1549556828 ^ o[r]; return e = i(u.concat(h(t)), 512 + 8 * t.length), a(i(c.concat(e), 640)); }(r(n), r(t))); }
      function t(n, t, r) { return t ? r ? u(t, n) : e(u(t, n)) : r ? o(n) : e(o(n)); }
      typeof define === 'function' && define.amd ? define(function () { return t; }) : typeof module === 'object' && module.exports ? module.exports = t : n.md5 = t;
  }(globalThis));
  ;
  ...
  (function () { function e(e) {
      ...
      for (var s = 0; s < e.length; ++s) {
          ...
          var i = e[s];
          if (typeof i !== 'object')
              return n.valid = !1, n.error = o + 'must be an object, but ' + typeof i + ' given', n;
          if (!a.helper.isString(i.type))
              return n.valid = !1, n.error = o + 'property "type" must be a string, but ' + typeof i.type + ' given', n;
          var l = i.type = i.type.toLowerCase();
          if (l === 'language' && (l = i.type = 'lang'), l === 'html' && (l = i.type = 'output'), l !== 'lang' && l !== 'output' && l !== 'listener')
          ...
          if (i.listeners) {
              ...
              for (var c in i.listeners)
                  if (i.listeners.hasOwnProperty(c) && typeof i.listeners[c] !== 'function')
          ...
          if (i.filter) {
              if (typeof i.filter !== 'function')
                  return n.valid = !1, n.error = o + '"filter" must be a function, but ' + typeof i.filter + ' given', n;
          }
          else if (i.regex) {
              ...
              if (a.helper.isUndefined(i.replace))
                  return n.valid = !1, n.error = o + '"regex" extensions must implement a replace string or function', n;
          }
      }
      return n;
  } function t(e, r) {
      ...
      typeof t === 'function' && (t = t()), a.helper.isArray(t) || (t = [t]);
      var n = r(t, e);
      if (!n.valid)
          throw Error(n.error);
      s[e] = t;
      ...
      var c = a || '';
      var u = c.indexOf('g') > -1;
      var d = new RegExp(r + '|' + t, 'g' + c.replace(/g/g, ''));
      var p = new RegExp(r, c.replace(/g/g, ''));
      var h = [];
      do {
          for (n = 0; o = d.exec(e);)
              if (p.test(o[0]))
                  n++ || (i = (s = d.lastIndex) - o[0].length);
              else if (n && !--n) {
      ...
      if (u > 0) {
          var d = [];
          i[0].wholeMatch.start !== 0 && d.push(e.slice(0, i[0].wholeMatch.start));
          for (var p = 0; p < u; ++p)
      ...
      return e = e.replace(/./g, function (e) { if (e === '@')
          e = r[Math.floor(2 * Math.random())](e);
      else {
          var t = Math.random();
  ...
  }, typeof console === 'undefined' && (console = { warn: function (e) {
          'use strict';
          alert(e);
      }, log: function (e) {
          'use strict';
      ...
      'use strict';
      function t(e, t) { if (t = t || null, a.helper.isString(e)) {
          if (e = a.helper.stdExtName(e), t = e, a.extensions[e])
              return console.warn('DEPRECATION WARNING: ' + e + ' is an old extension that uses a deprecated loading method.Please inform the developer that the extension should be updated!'), void (function (e, t) { typeof e === 'function' && (e = e(new a.Converter())); a.helper.isArray(e) || (e = [e]); var n = r(e, t); if (!n.valid)
                  throw Error(n.error); for (var s = 0; s < e.length; ++s)
                  switch (e[s].type) {
                      case 'lang':
                          u.push(e[s]);
                          break;
          ...
          e = s[e];
      } typeof e === 'function' && (e = e()), a.helper.isArray(e) || (e = [e]); var o = r(e, t); if (!o.valid)
          throw Error(o.error); for (var i = 0; i < e.length; ++i) {
          switch (e[i].type) {
              case 'lang':
                  u.push(e[i]);
                  break;
              case 'output': d.push(e[i]);
          }
          if (e[i].hasOwnProperty('listeners'))
              for (var l in e[i].listeners)
                  e[i].listeners.hasOwnProperty(l) && n(l, e[i].listeners[l]);
      } }
      function n(e, r) { if (!a.helper.isString(e))
          throw Error('Invalid argument in converter.listen() method: name must be a string, but ' + typeof e + ' given'); if (typeof r !== 'function')
          throw Error('Invalid argument in converter.listen() method: callback must be a function, but ' + typeof r + ' given'); p.hasOwnProperty(e) || (p[e] = []), p[e].push(r); }
      var c = {};
      var u = [];
      var d = [];
      var p = {};
      var h = i;
      var _ = { parsed: {}, raw: '', format: '' };
      !(function () { e = e || {}; for (var r in o)
          o.hasOwnProperty(r) && (c[r] = o[r]); if (typeof e !== 'object')
          throw Error('Converter expects the passed parameter to be an object, but ' + typeof e + ' was passed instead.'); for (var n in e)
          e.hasOwnProperty(n) && (c[n] = e[n]); c.extensions && a.helper.forEach(c.extensions, t); }()), this._dispatch = function (e, r, t, a) { if (p.hasOwnProperty(e))
          for (var n = 0; n < p[e].length; ++n) {
              var s = p[e][n](e, r, this, t, a);
              s && void 0 !== s && (r = s);
          } return r; }, this.listen = function (e, r) { return n(e, r), this; }, this.makeHtml = function (e) { if (!e)
          return e; var r = { gHtmlBlocks: [], gHtmlMdBlocks: [], gHtmlSpans: [], gUrls: {}, gTitles: {}, gDimensions: {}, gListLevel: 0, hashLinkCounts: {}, langExtensions: u, outputModifiers: d, converter: this, ghCodeBlocks: [], metadata: { parsed: {}, raw: '', format: '' } }; return e = e.replace(/¨/g, '¨T'), e = e.replace(/\$/g, '¨D'), e = e.replace(/\r\n/g, '\n'), e = e.replace(/\r/g, '\n'), e = e.replace(/\u00A0/g, '&nbsp;'), c.smartIndentationFix && (e = (function (e) { var r = e.match(/^\s*/)[0].length; var t = new RegExp('^\\s{0,' + r + '}', 'gm'); return e.replace(t, ''); }(e))), e = '\n\n' + e + '\n\n', e = a.subParser('detab')(e, c, r), e = e.replace(/^[ \t]+$/gm, ''), a.helper.forEach(u, function (t) { e = a.subParser('runExtension')(t, e, c, r); }), e = a.subParser('metadata')(e, c, r), e = a.subParser('hashPreCodeTags')(e, c, r), e = a.subParser('githubCodeBlocks')(e, c, r), e = a.subParser('hashHTMLBlocks')(e, c, r), e = a.subParser('hashCodeTags')(e, c, r), e = a.subParser('stripLinkDefinitions')(e, c, r), e = a.subParser('blockGamut')(e, c, r), e = a.subParser('unhashHTMLSpans')(e, c, r), e = a.subParser('unescapeSpecialChars')(e, c, r), e = e.replace(/¨D/g, '$$'), e = e.replace(/¨T/g, '¨'), e = a.subParser('completeHTMLDocument')(e, c, r), a.helper.forEach(d, function (t) { e = a.subParser('runExtension')(t, e, c, r); }), _ = r.metadata, e; }, this.makeMarkdown = this.makeMd = function (e, r) { function t(e) { for (var r = 0; r < e.childNodes.length; ++r) {
          var a = e.childNodes[r];
          a.nodeType === 3 ? /\S/.test(a.nodeValue) ? (a.nodeValue = a.nodeValue.split('\n').join(' '), a.nodeValue = a.nodeValue.replace(/(\s)+/g, '$1')) : (e.removeChild(a), --r) : a.nodeType === 1 && t(a);
      } } if (e = e.replace(/\r\n/g, '\n'), e = e.replace(/\r/g, '\n'), e = e.replace(/>[ \t]+</, '>¨NBSP;<'), !r) {
          if (!window || !window.document)
              throw new Error('HTMLParser is undefined. If in a webworker or nodejs environment, you need to provide a WHATWG DOM and HTML such as JSDOM');
          r = window.document;
      } var n = r.createElement('div'); n.innerHTML = e; var s = { preList: (function (e) { for (var r = e.querySelectorAll('pre'), t = [], n = 0; n < r.length; ++n)
              if (r[n].childElementCount === 1 && r[n].firstChild.tagName.toLowerCase() === 'code') {
                  var s = r[n].firstChild.innerHTML.trim();
                  var o = r[n].firstChild.getAttribute('data-language') || '';
                  if (o === '')
                  ...
                  t.push(r[n].innerHTML), r[n].innerHTML = '', r[n].setAttribute('prenum', n.toString()); return t; }(n)) }; t(n); for (var o = n.childNodes, i = '', l = 0; l < o.length; l++)
          i += a.subParser('makeMarkdown.node')(o[l], s); return i; }, this.setOption = function (e, r) { c[e] = r; }, this.getOption = function (e) { return c[e]; }, this.getOptions = function () { return c; }, this.addExtension = function (e, r) { t(e, r = r || null); }, this.useExtension = function (e) { t(e); }, this.setFlavor = function (e) { if (!l.hasOwnProperty(e))
          throw Error(e + ' flavor was not found'); var r = l[e]; h = e; for (var t in r)
          r.hasOwnProperty(t) && (c[t] = r[t]); }, this.getFlavor = function () { return h; }, this.removeExtension = function (e) { a.helper.isArray(e) || (e = [e]); for (var r = 0; r < e.length; ++r) {
          for (var t = e[r], n = 0; n < u.length; ++n)
              u[n] === t && u[n].splice(n, 1);
          for (; d.length > 0; ++n)
              d[0] === t && d[0].splice(n, 1);
      } }, this.getAllExtensions = function () { return { language: u, output: d }; }, this.getMetadata = function (e) { return e ? _.raw : _.parsed; }, this.getMetadataFormat = function () { return _.format; }, this._setMetadataPair = function (e, r) { _.parsed[e] = r; }, this._setMetadataFormat = function (e) { _.format = e; }, this._setMetadataRaw = function (e) { _.raw = e; };
  }, a.subParser('anchors', function (e, r, t) {
      'use strict';
      var n = function (e, n, s, o, i, l, c) { if (a.helper.isUndefined(c) && (c = ''), s = s.toLowerCase(), e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
          o = '';
      else if (!o) {
          if (s || (s = n.toLowerCase().replace(/ ?\n/g, ' ')), o = '#' + s, a.helper.isUndefined(t.gUrls[s]))
              return e;
          o = t.gUrls[s], a.helper.isUndefined(t.gTitles[s]) || (c = t.gTitles[s]);
      } var u = '<a href="' + (o = o.replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'; return c !== '' && c !== null && (u += ' title="' + (c = (c = c.replace(/"/g, '&quot;')).replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'), r.openLinksInNewWindow && !/^#/.test(o) && (u += ' rel="noopener noreferrer" target="¨E95Eblank"'), u += '>' + n + '</a>'; };
      return e = (e = t.converter._dispatch('anchors.before', e, r, t)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, n), e = e.replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, n), e = e.replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, n), e = e.replace(/\[([^\[\]]+)]()()()()()/g, n), r.ghMentions && (e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, function (e, t, n, s, o) { if (n === '\\')
          return t + s; if (!a.helper.isString(r.ghMentionsLink))
          throw new Error('ghMentionsLink option must be a string'); var i = r.ghMentionsLink.replace(/\{u}/g, o); var l = ''; return r.openLinksInNewWindow && (l = ' rel="noopener noreferrer" target="¨E95Eblank"'), t + '<a href="' + i + '"' + l + '>' + s + '</a>'; })), e = t.converter._dispatch('anchors.after', e, r, t);
  }); var u = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi; var d = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+?)([.!?,()\[\]])?(\1)?(?=\s|$)(?!["<>])/gi; var p = /()<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)()>()/gi; var h = /(^|\s)(?:mailto:)?([A-Za-z0-9!#$%&'*+-/=?^_`{|}~.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?=$|\s)/gim; var _ = /<()(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi; var g = function (e) {
      'use strict';
      return function (r, t, n, s, o, i, l) { var c = n = n.replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback); var u = ''; var d = ''; var p = t || ''; var h = l || ''; return /^www\./i.test(n) && (n = n.replace(/^www\./i, 'http://www.')), e.excludeTrailingPunctuationFromURLs && i && (u = i), e.openLinksInNewWindow && (d = ' rel="noopener noreferrer" target="¨E95Eblank"'), p + '<a href="' + n + '"' + d + '>' + c + '</a>' + u + h; };
  }; var m = function (e, r) {
      'use strict';
      return function (t, n, s) { var o = 'mailto:'; return n = n || '', s = a.subParser('unescapeSpecialChars')(s, e, r), e.encodeEmails ? (o = a.helper.encodeEmailAddress(o + s), s = a.helper.encodeEmailAddress(s)) : o += s, n + '<a href="' + o + '">' + s + '</a>'; };
      ...
      return e = (e += '¨0').replace(/(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=¨0))/g, function (e, n, s) { var o = n; var i = s; var l = '\n'; return o = a.subParser('outdent')(o, r, t), o = a.subParser('encodeCode')(o, r, t), o = a.subParser('detab')(o, r, t), o = o.replace(/^\n+/g, ''), o = o.replace(/\n+$/g, ''), r.omitExtraWLInCodeBlocks && (l = ''), o = '<pre><code>' + o + l + '</code></pre>', a.subParser('hashBlock')(o, r, t) + i; }), e = e.replace(/¨0/, ''), e = t.converter._dispatch('codeBlocks.after', e, r, t);
  }), a.subParser('codeSpans', function (e, r, t) {
      'use strict';
      return void 0 === (e = t.converter._dispatch('codeSpans.before', e, r, t)) && (e = ''), e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (e, n, s, o) { var i = o; return i = i.replace(/^([ \t]*)/g, ''), i = i.replace(/[ \t]*$/g, ''), i = a.subParser('encodeCode')(i, r, t), i = n + '<code>' + i + '</code>', i = a.subParser('hashHTMLSpans')(i, r, t); }), e = t.converter._dispatch('codeSpans.after', e, r, t);
      ...
      var n = '<!DOCTYPE HTML>\n';
      var s = '';
      var o = '<meta charset="utf-8">\n';
      var i = '';
      var l = '';
      void 0 !== t.metadata.parsed.doctype && (n = '<!DOCTYPE ' + t.metadata.parsed.doctype + '>\n', (a = t.metadata.parsed.doctype.toString().toLowerCase()) !== 'html' && a !== 'html5' || (o = '<meta charset="utf-8">'));
          ...
          if (t.metadata.parsed.hasOwnProperty(c))
              switch (c.toLowerCase()) {
                  ...
                  case 'title':
                      ...
                      break;
                  case 'charset':
                      o = a === 'html' || a === 'html5' ? '<meta charset="' + t.metadata.parsed.charset + '">\n' : '<meta name="charset" content="' + t.metadata.parsed.charset + '">\n';
                      break;
                  case 'language':
                  case 'lang':
                      i = ' lang="' + t.metadata.parsed[c] + '"', l += '<meta name="' + c + '" content="' + t.metadata.parsed[c] + '">\n';
                      break;
                  default: l += '<meta name="' + c + '" content="' + t.metadata.parsed[c] + '">\n';
              }
      return e = n + '<html' + i + '>\n<head>\n' + s + o + l + '</head>\n<body>\n' + e.trim() + '\n</body>\n</html>', e = t.converter._dispatch('completeHTMLDocument.after', e, r, t);
  }), a.subParser('detab', function (e, r, t) {
      'use strict';
      return e = t.converter._dispatch('detab.before', e, r, t), e = e.replace(/\t(?=\t)/g, '    '), e = e.replace(/\t/g, '¨A¨B'), e = e.replace(/¨B(.+?)¨A/g, function (e, r) { for (var t = r, a = 4 - t.length % 4, n = 0; n < a; n++)
          t += ' '; return t; }), e = e.replace(/¨A/g, '    '), e = e.replace(/¨B/g, ''), e = t.converter._dispatch('detab.after', e, r, t);
      ...
      if (!r.emoji)
          return e;
      return e = (e = t.converter._dispatch('emoji.before', e, r, t)).replace(/:([\S]+?):/g, function (e, r) { return a.helper.emojis.hasOwnProperty(r) ? a.helper.emojis[r] : e; }), e = t.converter._dispatch('emoji.after', e, r, t);
      ...
      'use strict';
      return e = (e = t.converter._dispatch('escapeSpecialCharsWithinTagAttributes.before', e, r, t)).replace(/<\/?[a-z\d_:-]+(?:[\s]+[\s\S]+?)?>/gi, function (e) { return e.replace(/(.)<\/?code>(?=.)/g, '$1`').replace(/([\\`*_~=|])/g, a.helper.escapeCharactersCallback); }), e = e.replace(/<!(--(?:(?:[^>-]|-[^>])(?:[^-]|-[^-])*)--)>/gi, function (e) { return e.replace(/([\\`*_~=|])/g, a.helper.escapeCharactersCallback); }), e = t.converter._dispatch('escapeSpecialCharsWithinTagAttributes.after', e, r, t);
      ...
      'use strict';
      return function (e, r) { var a = r; return a = a.replace(/\n\n/g, '\n'), a = a.replace(/^\n/, ''), a = a.replace(/\n+$/g, ''), a = '\n\n¨K' + (t.gHtmlBlocks.push(a) - 1) + 'K\n\n'; };
      ...
      var s = function (e, r, a, n) { var s = e; return a.search(/\bmarkdown\b/) !== -1 && (s = a + t.converter.makeHtml(r) + n), '\n\n¨K' + (t.gHtmlBlocks.push(s) - 1) + 'K\n\n'; };
      r.backslashEscapesHTMLTags && (e = e.replace(/\\<(\/?[^>]+?)>/g, function (e, r) { return '&lt;' + r + '&gt;'; }));
      for (var o = 0; o < n.length; ++o)
          for (var i, l = new RegExp('^ {0,3}(<' + n[o] + '\\b[^>]*>)', 'im'), c = '<' + n[o] + '\\b[^>]*>', u = '</' + n[o] + '>'; (i = a.helper.regexIndexOf(e, l)) !== -1;) {
              var d = a.helper.splitAtIndex(e, i);
              var p = a.helper.replaceRecursiveRegExp(d[1], s, c, u, 'im');
              if (p === d[1])
                  break;
              e = d[0].concat(p);
          }
      ...
      for (var a = 0; a < t.gHtmlSpans.length; ++a) {
          for (var n = t.gHtmlSpans[a], s = 0; /¨C(\d+)C/.test(n);) {
              var o = RegExp.$1;
              if (n = n.replace('¨C' + o + 'C', t.gHtmlSpans[o]), s === 10) {
      ...
      'use strict';
      function n(e) { var n, s; if (r.customizedHeaderId) {
          var o = e.match(/\{([^{]+?)}\s*$/);
          o && o[1] && (e = o[1]);
      ...
      var o = r.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm;
      var i = r.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
      e = (e = e.replace(o, function (e, o) { var i = a.subParser('spanGamut')(o, r, t); var l = r.noHeaderId ? '' : ' id="' + n(o) + '"'; var c = '<h' + s + l + '>' + i + '</h' + s + '>'; return a.subParser('hashBlock')(c, r, t); })).replace(i, function (e, o) { var i = a.subParser('spanGamut')(o, r, t); var l = r.noHeaderId ? '' : ' id="' + n(o) + '"'; var c = s + 1; var u = '<h' + c + l + '>' + i + '</h' + c + '>'; return a.subParser('hashBlock')(u, r, t); });
      var l = r.requireSpaceBeforeHeadingText ? /^(#{1,6})[ \t]+(.+?)[ \t]*#*\n+/gm : /^(#{1,6})[ \t]*(.+?)[ \t]*#*\n+/gm;
      return e = e.replace(l, function (e, o, i) { var l = i; r.customizedHeaderId && (l = i.replace(/\s?\{([^{]+?)}\s*$/, '')); var c = a.subParser('spanGamut')(l, r, t); var u = r.noHeaderId ? '' : ' id="' + n(i) + '"'; var d = s - 1 + o.length; var p = '<h' + d + u + '>' + c + '</h' + d + '>'; return a.subParser('hashBlock')(p, r, t); }), e = t.converter._dispatch('headers.after', e, r, t);
      ...
      'use strict';
      function n(e, r, n, s, o, i, l, c) { var u = t.gUrls; var d = t.gTitles; var p = t.gDimensions; if (n = n.toLowerCase(), c || (c = ''), e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)
          s = '';
      else if (s === '' || s === null) {
          if (n !== '' && n !== null || (n = r.toLowerCase().replace(/ ?\n/g, ' ')), s = '#' + n, a.helper.isUndefined(u[n]))
              return e;
      ...
      for (o = s.length, i = 0; i < o; i++) {
          for (var c = '', u = s[i], d = !1; /¨(K|G)(\d+)\1/.test(u);) {
              var p = RegExp.$1;
              var h = RegExp.$2;
              c = (c = p === 'K' ? t.gHtmlBlocks[h] : d ? a.subParser('encodeCode')(t.ghCodeBlocks[h].text, r, t) : t.ghCodeBlocks[h].codeblock).replace(/\$/g, '$$$$'), u = u.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, c), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(u) && (d = !0);
          }
          s[i] = u;
      }
      ...
      'use strict';
      return r.strikethrough && (e = (e = t.converter._dispatch('strikethrough.before', e, r, t)).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, function (e, n) { return (function (e) { return r.simplifiedAutoLink && (e = a.subParser('simplifiedAutoLinks')(e, r, t)), '<del>' + e + '</del>'; }(n)); }), e = t.converter._dispatch('strikethrough.after', e, r, t)), e;
  }), a.subParser('stripLinkDefinitions', function (e, r, t) {
      'use strict';
      var n = function (e, n, s, o, i, l, c) { return n = n.toLowerCase(), s.match(/^data:.+?\/.+?;base64,/) ? t.gUrls[n] = s.replace(/\s/g, '') : t.gUrls[n] = a.subParser('encodeAmpsAndAngles')(s, r, t), l ? l + c : (c && (t.gTitles[n] = c.replace(/"|'/g, '&quot;')), r.parseImgDimensions && o && i && (t.gDimensions[n] = { width: o, height: i }), ''); };
      ...
      function i(e) { var i; var l = e.split('\n'); for (i = 0; i < l.length; ++i)
          /^ {0,3}\|/.test(l[i]) && (l[i] = l[i].replace(/^ {0,3}\|/, '')), /\|[ \t]*$/.test(l[i]) && (l[i] = l[i].replace(/\|[ \t]*$/, '')), l[i] = a.subParser('codeSpans')(l[i], r, t); var c = l[0].split('|').map(function (e) { return e.trim(); }); var u = l[1].split('|').map(function (e) { return e.trim(); }); var d = []; var p = []; var h = []; var _ = []; for (l.shift(), l.shift(), i = 0; i < l.length; ++i)
          l[i].trim() !== '' && d.push(l[i].split('|').map(function (e) { return e.trim(); })); if (c.length < u.length)
          return e; for (i = 0; i < u.length; ++i)
          h.push(n(u[i])); for (i = 0; i < c.length; ++i)
          a.helper.isUndefined(h[i]) && (h[i] = ''), p.push(s(c[i], h[i])); for (i = 0; i < d.length; ++i) {
          for (var g = [], m = 0; m < p.length; ++m)
              a.helper.isUndefined(d[i][m]), g.push(o(d[i][m], h[m]));
          _.push(g);
      } return (function (e, r) { for (var t = '<table>\n<thead>\n<tr>\n', a = e.length, n = 0; n < a; ++n)
          t += e[n]; for (t += '</tr>\n</thead>\n<tbody>\n', n = 0; n < r.length; ++n) {
          t += '<tr>\n';
          for (var s = 0; s < a; ++s)
              t += r[n][s];
      ...
      'use strict';
      return r.underline ? (e = t.converter._dispatch('underline.before', e, r, t), e = r.literalMidWordUnderscores ? (e = e.replace(/\b___(\S[\s\S]*?)___\b/g, function (e, r) { return '<u>' + r + '</u>'; })).replace(/\b__(\S[\s\S]*?)__\b/g, function (e, r) { return '<u>' + r + '</u>'; }) : (e = e.replace(/___(\S[\s\S]*?)___/g, function (e, r) { return /\S$/.test(r) ? '<u>' + r + '</u>' : e; })).replace(/__(\S[\s\S]*?)__/g, function (e, r) { return /\S$/.test(r) ? '<u>' + r + '</u>' : e; }), e = e.replace(/(_)/g, a.helper.escapeCharactersCallback), e = t.converter._dispatch('underline.after', e, r, t)) : e;
  }), a.subParser('unescapeSpecialChars', function (e, r, t) {
      'use strict';
      return e = t.converter._dispatch('unescapeSpecialChars.before', e, r, t), e = e.replace(/¨E(\d+)E/g, function (e, r) { var t = parseInt(r); return String.fromCharCode(t); }), e = t.converter._dispatch('unescapeSpecialChars.after', e, r, t);
      ...
      var a = e.getAttribute('precodenum');
      return '```' + t + '\n' + r.preList[a] + '\n```';
      ...
      for (var s = e.childNodes, o = s.length, i = e.getAttribute('start') || 1, l = 0; l < o; ++l)
          if (void 0 !== s[l].tagName && s[l].tagName.toLowerCase() === 'li') {
              n += (t === 'ol' ? i.toString() + '. ' : '- ') + a.subParser('makeMarkdown.listItem')(s[l], r), ++i;
          }
      return (n += '\n\x3c!-- --\x3e\n').trim();
      ...
      var n = '';
      if (e.nodeType === 3)
          return a.subParser('makeMarkdown.txt')(e, r);
      if (e.nodeType === 8)
      ...
      var s = '';
      var o = [[], []];
      var i = e.querySelectorAll('thead>tr>th');
      var l = e.querySelectorAll('tbody>tr');
      ...
      for (t = 0; t < l.length; ++t) {
          var d = o.push([]) - 1;
          var p = l[t].getElementsByTagName('td');
      ...
      for (t = 0; t < o.length; ++t) {
          for (n = 0; n < o[t].length; ++n)
              t === 1 ? o[t][n].slice(-1) === ':' ? o[t][n] = a.helper.padEnd(o[t][n].slice(-1), _ - 1, '-') + ':' : o[t][n] = a.helper.padEnd(o[t][n], _, '-') : o[t][n] = a.helper.padEnd(o[t][n], _);
          s += '| ' + o[t].join(' | ') + ' |\n';
      }
      return s.trim();
      ...
      'use strict';
      return a;
  }) : typeof module !== 'undefined' && module.exports ? module.exports = a : this.showdown = a; }).call(globalThis);
  // # sourceMappingURL=showdown.min.js.map
  ;
  'use strict';
  const atVersion = '0.1.0';
  ...
  ;
  'use strict';
  const ArtitalkTurnstile = (function () {
      let siteKey = '';
      let responseToken = '';
      let widgetId = '';
      let loading = false;
      function render(containerId) {
          ...
          widgetId = window.turnstile.render(container, {
              sitekey: siteKey,
              callback: function (token) { responseToken = token; },
              'expired-callback': function () { responseToken = ''; },
              'error-callback': function () { responseToken = ''; }
          });
      }
      return {
          configure: function (value) { siteKey = value || ''; },
          show: function (containerId) {
              ...
              script.async = true;
              script.defer = true;
              script.onload = function () { loading = false; render(containerId); };
              document.head.appendChild(script);
          },
          token: function () { return responseToken; },
          reset: function () {
              responseToken = '';
  ...
  atEvery.prototype._init = function () {
      const root = this;
      let { appId, appKey, lang, pageSize, atEmoji, bgImg, motion, cssUrl, shuoPla, avatarPla, serverURL, turnstileSiteKey, mediaUploadEnabled, color1, color2, color3, blackAndWhiteTheme, onLogin, onShuoPublished, onCommentsPublished } = root.config;
  ...
  atEvery.prototype.beginUpload = function (file) {
      ...
      xhr.addEventListener('readystatechange', function () {
          if (this.readyState === 4 && this.status === 200) {
              const sourceUrl = JSON.parse(this.responseText);
  ...
  atEvery.prototype.seeContent = function (pageNum, option) {
      const root = this;
      let mid = '';
      let { lang, pageSize, motion, atEmoji, color1, color2, color3, atComment, turnstileSiteKey, onCommentsPublished } = root.config;
      lang = ArtitalkI18n.normalizeLanguage(lang);
      ...
      ArtitalkData.queryTalks(Number(pageSize), pageNum).then(function (shuoContent) {
          ...
          pinnedTalkIds.forEach(function (id) {
              ...
              if (talk)
                  talk.insertAdjacentHTML('afterbegin', ArtitalkTemplates.render('pinnedBadge', { label: pinned }));
              if (controls)
                  controls.insertAdjacentHTML('afterbegin', ArtitalkTemplates.render('pinButton', { id, isPinned: true, label: unpin }));
          });
          if (ArtitalkData.currentUser()) {
              shuoContent.forEach(function (talk) {
                  ...
                  if (controls)
                      controls.insertAdjacentHTML('afterbegin', ArtitalkTemplates.render('pinButton', { id: talk.id, isPinned: false, label: pin }));
              });
          }
          if (atComment !== 0) {
      ...
      atEvery.prototype.saveComment = function (id, option) {
          ...
          const currentUser = ArtitalkData.currentUser();
          const comEmail = requiredElement('email').value.trim().toLowerCase();
          ...
          if (!currentUser) {
              ...
              atComment.set('_honeypot', requiredElement('momentide-honeypot').value);
          }
          ...
          atComment.save().then(function (res) {
              ...
              fadeOut('lazy');
              ArtitalkTurnstile.reset();
              requiredElement('neirong').value = error.message + '\n' + comContent;
          });
      };
      ...
      atEvery.prototype.commentInit = function (id, option) {
          ...
          let mid = '';
          const currentUser = ArtitalkData.currentUser();
          if (!currentUser && turnstileSiteKey)
              ArtitalkTurnstile.show('momentide-turnstile');
          ArtitalkData.queryComments(id).then(res => {
  ...
  globalThis.Artitalk = Artitalk; globalThis.atEvery = atEvery; globalThis.Logout = Logout; globalThis.insertEmoji = insertEmoji; globalThis.preview = preview;
