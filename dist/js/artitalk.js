...
const ArtitalkSvg = {
  render: function (name, values) {
    ...
    return svg.replace(/\{\{([a-zA-Z0-9_]+)\}\}|currentColor/g, function (placeholder, key) {
      if (placeholder === 'currentColor') return values && values.color ? values.color : placeholder;
