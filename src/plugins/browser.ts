 ...
 * @author houchuanjie
 */
interface LegacyOpera {
  version(): string | number;
}

type BrowserDetectorWindow = Window & typeof globalThis & {
  opera?: LegacyOpera;
};

;(function (window: BrowserDetectorWindow, document: Document): void {
  ...
  type ClientInstance = ClientResult & ClientMethods;

  interface ClientImplementationConstructor {
    new (): ClientResult;
    prototype: ClientMethods;
  }

  class Engine implements EngineInfo {
    name: string | null = null;
    version: string | number | null = null;
  }

  class System implements SystemInfo {
    name: string | null = null;
    version: string | number | null = null;
  }

  class Browser implements BrowserInfo {
    name: string | null = null; // 浏览器名称
    version: string | number | null = null; // 浏览器版本号
  }

  const Client = function (this: ClientInstance): ClientResult {
  ...
  } as unknown as ClientImplementationConstructor;

  Client.prototype = {
    init: function (this: ClientInstance): void {
      this.judgeBrowser();
      this.judgeSystem();
    },
    judgeBrowser: function (this: ClientInstance): void {
    ...
    judgeSystem: function (this: ClientInstance): void {
...
}(window as BrowserDetectorWindow, document));
